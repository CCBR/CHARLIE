...
parser.add_argument('--CircRNACount', dest='CircRNACount', type=str, required=True,
                    help='CircRNACount output file from DCC')
...
new_names = ['chr', 'start', 'end', 'strand', 'read_count']
